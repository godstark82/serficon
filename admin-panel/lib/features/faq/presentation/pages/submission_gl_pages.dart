...
class SubmissionGuidelinesPage extends StatefulWidget {
  const SubmissionGuidelinesPage({super.key});

  @override
  State<SubmissionGuidelinesPage> createState() =>
      _SubmissionGuidelinesPageState();
}

class _SubmissionGuidelinesPageState extends State<SubmissionGuidelinesPage> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Submission Guidelines'),
        actions: [
          IconButton(
            icon: const Icon(Icons.edit),
            onPressed: () {
              // Navigator.pushNamed(context, '/edit-review-process');
              Get.toNamed(Routes.dashboard + Routes.updateSubmission);
            },
          ),
        ],
      ),
      body: BlocBuilder<FaqBloc, FaqState>(
        builder: (context, state) {
          ...
          if (state is SubmissionProcessLoaded) {
            return Container(
