...
class DefaultFirebaseOptions {
  ...
  static  FirebaseOptions web = FirebaseOptions(
    ...
    messagingSenderId: dotenv.get('FIREBASE_OPTIONS_MESSAGING_SENDER_ID'),
    projectId: dotenv.get('FIREBASE_OPTIONS_PROJECT_ID'),
    authDomain: dotenv.get('FIREBASE_OPTIONS_AUTH_DOMAIN'),
    storageBucket: dotenv.get('FIREBASE_OPTIONS_STORAGE_BUCKET'),
    measurementId: dotenv.get('FIREBASE_OPTIONS_MEASUREMENT_ID'),
  );
