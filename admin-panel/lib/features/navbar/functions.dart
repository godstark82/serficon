...
Future<void> showEditPageDialog(BuildContext context, Function() callback, NavItem item) async {
                  ...
                  if (item.parentId == null) {
                    ...
                    if (parentDoc.exists) {
                      ...
                      final index = children
                          .indexWhere((child) => child['id'] == item.id);
                      if (index != -1) {
...
Future<void> deleteNavItem(BuildContext context, Function() callback, NavItem item) async {
