...
class SubmissionGlPage extends StatefulWidget {
  const SubmissionGlPage({super.key});

  @override
  State<SubmissionGlPage> createState() => _SubmissionGlPageState();
}

class _SubmissionGlPageState extends State<SubmissionGlPage> {
  @override
  void initState() {
    super.initState();
    context
        .read<PagesBloc>()
        .add(const GetPageByIdEvent('submission_guidelines'));
  }
